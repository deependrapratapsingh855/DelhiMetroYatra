...
public class Map extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // final ProgressDialog dialog=ProgressDialog.show(Map.this,"Connecting Please Wait","Connecting",true);
        w.loadUrl("http://www.delhimetrorail.com/images/DMRC-Map.jpg");
